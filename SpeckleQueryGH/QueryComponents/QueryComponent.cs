...
namespace ConnectorGrasshopperExtension.QueryComponents
{
    public class QueryComponent : GH_TaskCapableComponent<QueryComponent.SolveResults>
    {
        ...
        protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
        {
            ...
            //  GH_ParamAccess.item));
            pManager.AddTextParameter("Stream ID/URL", "ID/URL", "Speckle stream ID or URL", GH_ParamAccess.item);
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            if (InPreSolve)
            {
                ...
                {
                    idWrapper = new StreamWrapper(streamid);
